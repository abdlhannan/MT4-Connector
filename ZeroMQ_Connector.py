...
class ZeroMQ_Connector():
    ...
    def GET_HISTORICAL_TRADES_(self):
        ...
        try:
            self.temp_order_dict['_action'] = 'GET_HISTORICAL_TRADES'
    ...
    def _DWX_MTX_CLOSE_ALL_TRADES_(self):
        ...
        try:
            ...
            pass
    # GET DEPOSIT
    def _DWX_MTX_GET_DEPOSIT(self):
        try:
            self.temp_order_dict['_action'] = 'GET_DEPOSIT'
            ...
            pass
    # GET POSITION ORDERS
    def GET_ALL_POSITION_ORDERS_(self):
        
        try:
            self.temp_order_dict['_action'] = 'GETPOSITIONORDERS'   
            # Execute
            self._DWX_MTX_SEND_COMMAND_(**self.temp_order_dict)
    ...
    def GET_CURRENT_BALANCE(self):
        try:
            self.temp_order_dict['_action'] = 'GETCURRENTBALANCE'
    ...
    def GET_CURRENT_EQUITY(self):
        try:
            self.temp_order_dict['_action'] = 'GETCURRENTEQUITY'
    ...
    def GET_ALL_OPEN_TRADES_(self):
        ...
        try:
            ...
            pass
    # GET SERVER TIME
    def GET_SERVER_TIME_(self):
        try:
            self.temp_order_dict['_action'] = 'GET_SERVER_TIME'
...
#_DWX_ZMQ_CLEANUP_()
#
#trade_dict = _zmq._generate_default_order_dict()

#trade_dict['_type'] = 2
#trade_dict['_symbol'] = 'EURUSD'
#trade_dict['_price'] = 1.17600
#trade_dict['_comment'] = 'test2'
#trade_dict['_lots'] = 0.02
#_zmq._DWX_MTX_NEW_TRADE_(trade_dict)
#_zmq._DWX_MTX_GET_ALL_POSITION_ORDERS_()
# Reset data output
_zmq = ZeroMQ_Connector()
_delay = 0.1
_wbreak=10
_zmq._set_response_(None)
_zmq.GET_HISTORICAL_TRADES_()
#_zmq.GET_ALL_OPEN_TRADES_()
...
if _zmq._valid_response_('zmq'):
    
    _response = _zmq._get_response_()
    #print('YOOOOOOOOOOOOOOOOOOOOO')
    print(_response)
_response = _response['_trades']
for i, (k, v) in enumerate(_response.items()):
    print(i, k)

'''
#_zmq._DWX_MTX_GET_DEPOSIT()
#_zmq._DWX_MTX_NEW_TRADE_()
_zmq._DWX_MTX_GET_DEPOSIT()

sleep(2)
print('OUTPUT DEPOSIT: ')
...
print(_zmq._thread_data_output)
#sleep(5)
_zmq._DWX_MTX_GET_CURRENT_BALANCE()
sleep(2)
...
''' 
#while True:
    #print(_zmq._DWX_ZMQ_Poll_Data_())
#    sleep(1)
